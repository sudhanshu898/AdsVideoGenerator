...
import { p as ClerkWebAuthnError } from "../../error-qcSj2j-M.mjs";
...
function handlePublicKeyError(error) {
	...
	if (error.name === "SecurityError") return new ClerkWebAuthnError(error.message, { code: "passkey_invalid_rpID_or_domain" });
	return error;
}
/**
