...
const require_error = require('./error-3LfPboYW.js');
...
const require_versionSelector = require('./versionSelector-cPoafZZr.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.0.0")}/dist/ui.browser.js`;
};
